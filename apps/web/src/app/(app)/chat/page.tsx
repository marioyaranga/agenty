      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-8 px-6 py-16">
        <header className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex flex-col gap-1">
            <p className="text-sm text-muted-foreground">workyAI · Fase 5</p>
            ...
            <p className="text-sm text-muted-foreground">
              El agente usa RAG sobre documentos indexados del espacio activo. Las
              llamadas van al API Flask con Bearer y{" "}
              <span className="font-mono text-xs">X-Tenant-Id</span>.
            </p>
          </div>
        ...
        <ChatPageClient tenants={tenants} />
      </main>
    </div>
  );
}
